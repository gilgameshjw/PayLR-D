...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__25025 = cljs.core.instance_QMARK_;
var expr__25026 = reactive_val;
if(cljs.core.truth_(pred__25025.call(null,reagent.ratom.RAtom,expr__25026))){
return "ra";
} else {
if(cljs.core.truth_(pred__25025.call(null,reagent.ratom.RCursor,expr__25026))){
return "rc";
} else {
if(cljs.core.truth_(pred__25025.call(null,reagent.ratom.Reaction,expr__25026))){
return "rx";
} else {
if(cljs.core.truth_(pred__25025.call(null,reagent.ratom.Track,expr__25026))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1554122630233
