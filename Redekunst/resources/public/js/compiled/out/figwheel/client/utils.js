...
return (new CustomEvent(event_name,(function (){var obj30463 = {"detail":data};
return obj30463;
})()));
} else {
...
var f = (function (){var pred__30470 = cljs.core._EQ_;
var expr__30471 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30470.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30471))){
return ((function (pred__30470,expr__30471){
return (function (p1__30464_SHARP_){
return console.warn(p1__30464_SHARP_);
});
;})(pred__30470,expr__30471))
} else {
if(cljs.core.truth_(pred__30470.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30471))){
return ((function (pred__30470,expr__30471){
return (function (p1__30465_SHARP_){
return console.debug(p1__30465_SHARP_);
});
;})(pred__30470,expr__30471))
} else {
if(cljs.core.truth_(pred__30470.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30471))){
return ((function (pred__30470,expr__30471){
return (function (p1__30466_SHARP_){
return console.error(p1__30466_SHARP_);
});
;})(pred__30470,expr__30471))
} else {
return ((function (pred__30470,expr__30471){
return (function (p1__30467_SHARP_){
return console.log(p1__30467_SHARP_);
});
;})(pred__30470,expr__30471))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30474){
...
var eval_fn = cljs.core.get.call(null,map__30475__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30477_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30479,(0),null);
...
}catch (e30484){if((e30484 instanceof Error)){
var e = e30484;
return not_found;
} else {
throw e30484;
...
//# sourceMappingURL=utils.js.map?rel=1554122641683
