...
var G__24877 = o;
(G__24877[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__24883 = jsprops;
(G__24883["defaultValue"] = value);

(G__24883["onChange"] = ((function (G__24883,v,value,on_change){
return (function (p1__24882_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24882_SHARP_);
});})(G__24883,v,value,on_change))
);
...
var vec__24886 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24886,(0),null);
var id = cljs.core.nth.call(null,vec__24886,(1),null);
var class$ = cljs.core.nth.call(null,vec__24886,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___24890 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___24890 == null)){
} else {
var key_24891 = temp__4661__auto___24890;
(jsprops["key"] = key_24891);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24892 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__24892["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24895){
...
break;
default:
var G__24902 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24902;
continue;
...
var n__4376__auto___24904 = a.length;
var i_24905 = (0);
while(true){
if((i_24905 < n__4376__auto___24904)){
(a[i_24905] = reagent.impl.template.as_element.call(null,(a[i_24905])));

var G__24906 = (i_24905 + (1));
i_24905 = G__24906;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___24907 = a.length;
var i_24908 = (0);
while(true){
if((i_24908 < n__4376__auto___24907)){
var val_24909 = (a[i_24908]);
if(((cljs.core.vector_QMARK_.call(null,val_24909)) && ((reagent.impl.template.key_from_vec.call(null,val_24909) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24908] = reagent.impl.template.as_element.call(null,val_24909));

var G__24910 = (i_24908 + (1));
i_24908 = G__24910;
continue;
} else {
}
...
var ctx = ({});
var vec__24911 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24911,(0),null);
var derefed = cljs.core.nth.call(null,vec__24911,(1),null);
...
var G__24914 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24914) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24914){
...
//# sourceMappingURL=template.js.map?rel=1554122629900
