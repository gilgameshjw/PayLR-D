...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__32746 = cljs.core.instance_QMARK_;
var expr__32747 = reactive_val;
if(cljs.core.truth_(pred__32746.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RAtom,expr__32747))){
return "ra";
} else {
if(cljs.core.truth_(pred__32746.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RCursor,expr__32747))){
return "rc";
} else {
if(cljs.core.truth_(pred__32746.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Reaction,expr__32747))){
return "rx";
} else {
if(cljs.core.truth_(pred__32746.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Track,expr__32747))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1554122648178
