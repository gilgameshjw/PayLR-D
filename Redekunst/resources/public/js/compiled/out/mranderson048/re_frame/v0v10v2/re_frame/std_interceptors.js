...
var vec__32800_32803 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_32804 = cljs.core.nth.call(null,vec__32800_32803,(0),null);
var only_after_32805 = cljs.core.nth.call(null,vec__32800_32803,(1),null);
var db_changed_QMARK__32806 = ((!((only_before_32804 == null))) || (!((only_after_32805 == null))));
if(db_changed_QMARK__32806){
...
mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_32804);

mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_32805);
...
var map__32807 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__32807__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__32807__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__32809 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__32809__$1;
var event = cljs.core.get.call(null,map__32809__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__4499__auto___32812 = arguments.length;
var i__4500__auto___32813 = (0);
while(true){
if((i__4500__auto___32813 < len__4499__auto___32812)){
args__4502__auto__.push((arguments[i__4500__auto___32813]));

var G__32814 = (i__4500__auto___32813 + (1));
i__4500__auto___32813 = G__32814;
continue;
} else {
}
break;
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq32811){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32811));
});
...
return cljs.core.get_in.call(null,new_db,p1__32815_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__32816_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__32816_SHARP_);
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq32817){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32818,G__32819,seq32817__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1554122648505
