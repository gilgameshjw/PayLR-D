...
var len__4499__auto___31501 = arguments.length;
var i__4500__auto___31502 = (0);
while(true){
if((i__4500__auto___31502 < len__4499__auto___31501)){
args__4502__auto__.push((arguments[i__4500__auto___31502]));

var G__31503 = (i__4500__auto___31502 + (1));
i__4500__auto___31502 = G__31503;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31498){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31499,G__31500,seq31498__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31504_SHARP_){
return !((cljs.core.meta.call(null,p1__31504_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__31505__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31509){var _e__30521__auto__ = e31509;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e31511){var _e__30521__auto__ = e31511;
return false;
}}
})())){
...
var _STAR_current_state_STAR_31513 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__31514 = opts;
...
var markup_db = cljs.core.get.call(null,map__31514__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_31513;
}});
...
;
var temp__4655__auto___31518 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___31518)){
var managed_print_level_31519 = temp__4655__auto___31518;
var _STAR_print_level_STAR_31517_31520 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_31519;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_31517_31520,managed_print_level_31519,temp__4655__auto___31518,writer,opts,job_fn){
return (function (p1__31516_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__31516_SHARP_,null);
});})(_STAR_print_level_STAR_31517_31520,managed_print_level_31519,temp__4655__auto___31518,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_31517_31520;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1554122643171
