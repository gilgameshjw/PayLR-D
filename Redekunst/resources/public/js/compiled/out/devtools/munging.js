...
var o31370 = temp__4655__auto__;
var temp__4655__auto____$1 = (o31370["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o31371 = temp__4655__auto____$1;
return (o31371["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30514__auto__ = f;
return (o__30514__auto__["toString"]).call(o__30514__auto__);
} else {
return "";
}
}catch (e31372){var _ = e31372;
return "";
}});
...
try{var o__30514__auto___31374 = t;
(o__30514__auto___31374["cljs$lang$ctorPrWriter"]).call(o__30514__auto___31374,t,writer);
}catch (e31373){var __31375 = e31373;
}
...
var char_code = (function (){var o__30514__auto__ = (new String(char$));
return (o__30514__auto__["charCodeAt"]).call(o__30514__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30514__auto__ = String;
return (o__30514__auto__["fromCharCode"]).call(o__30514__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31376 = num_code;
switch (G__31376) {
case (1):
return (185);
...
var o__30514__auto__ = String;
return (o__30514__auto__["fromCharCode"]).call(o__30514__auto__,superscript_code);
});
/**
...
}catch (e31378){var _e__30521__auto__ = e31378;
return false;
}})())){
...
var vec__31379 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__31379,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o31382 = temp__4655__auto__;
var temp__4655__auto____$1 = (o31382["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o31383 = temp__4655__auto____$1;
return (o31383["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___31390 = arguments.length;
var i__4500__auto___31391 = (0);
while(true){
if((i__4500__auto___31391 < len__4499__auto___31390)){
args__4502__auto__.push((arguments[i__4500__auto___31391]));

var G__31392 = (i__4500__auto___31391 + (1));
i__4500__auto___31391 = G__31392;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31386){
var vec__31387 = p__31386;
var ns_detector = cljs.core.nth.call(null,vec__31387,(0),null);
...
var G__31393 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__31394 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__31393;
remaining_tokens = G__31394;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31384){
var G__31385 = cljs.core.first.call(null,seq31384);
var seq31384__$1 = cljs.core.next.call(null,seq31384);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31385,seq31384__$1);
});
...
var vec__31398 = cljs.core.split_with.call(null,(function (p1__31397_SHARP_){
return cljs.core.not_EQ_.call(null,p1__31397_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__31398,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__31398,(1),null);
...
var vec__31401 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__31401,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__31401,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__31404 = cljs.core.rest.call(null,remaining_tokens);
var G__31405 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__31404;
name_tokens = G__31405;
continue;
} else {
...
var vec__31408 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__31408,(0),null);
var arity = cljs.core.nth.call(null,vec__31408,(1),null);
var vec__31411 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__31411,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__31411,(1),null);
var vec__31414 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__31414,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__31414,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__31414,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__31414,(3),null);
...
var vec__31420 = result;
var munged_ns = cljs.core.nth.call(null,vec__31420,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__31420,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__31420,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__31420,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__31420,(4),null);
var arity = cljs.core.nth.call(null,vec__31420,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__31424 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__31424,(0),null);
var args = cljs.core.nth.call(null,vec__31424,(1),null);
var vec__31427 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__31427,(0),null);
var name = cljs.core.nth.call(null,vec__31427,(1),null);
...
var G__31430 = (arity + (1));
var G__31431 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31432){
var vec__31433 = p__31432;
var arity = cljs.core.nth.call(null,vec__31433,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__31433,(1),null);
...
return cljs.core.get.call(null,arities,p1__31436_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__31437_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___31444 = arguments.length;
var i__4500__auto___31445 = (0);
while(true){
if((i__4500__auto___31445 < len__4499__auto___31444)){
args__4502__auto__.push((arguments[i__4500__auto___31445]));

var G__31446 = (i__4500__auto___31445 + (1));
i__4500__auto___31445 = G__31446;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31440){
var vec__31441 = p__31440;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__31441,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31438){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__31449__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__31449__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__31449__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__31449__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31450 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__31450,(0),null);
var fn_name = cljs.core.nth.call(null,vec__31450,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__31450,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__31450,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__31450,(4),null);
var arity = cljs.core.nth.call(null,vec__31450,(5),null);
...
var o__30514__auto__ = f;
return (o__30514__auto__["getBasis"]).call(o__30514__auto__);
});
/**
...
}catch (e31454){var _e__30521__auto__ = e31454;
...
var G__31455 = (obj[cljs.core.first.call(null,path)]);
var G__31456 = cljs.core.rest.call(null,path);
obj = G__31455;
path = G__31456;
continue;
} else {
...
return (function (accum,p__31457){
var vec__31458 = p__31457;
var bit = cljs.core.nth.call(null,vec__31458,(0),null);
var protocol = cljs.core.nth.call(null,vec__31458,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31461){
var vec__31462 = p__31461;
var ns = cljs.core.nth.call(null,vec__31462,(0),null);
var name = cljs.core.nth.call(null,vec__31462,(1),null);
var selector = cljs.core.nth.call(null,vec__31462,(2),null);
...
return (function (p__31466){
var vec__31467 = p__31466;
var munged_name = cljs.core.nth.call(null,vec__31467,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__31467,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__31467,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__31465_SHARP_){
return (obj[cljs.core.first.call(null,p1__31465_SHARP_)]);
});})(name,sorted_matches,vec__31467,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1554122642848
