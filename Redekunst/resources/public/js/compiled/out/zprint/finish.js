...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__34588_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__34588_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__34588_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__34589){
var vec__34590 = p__34589;
var low = cljs.core.nth.call(null,vec__34590,(0),null);
var high = cljs.core.nth.call(null,vec__34590,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__34593,s,color,element,idx){
var map__34594 = p__34593;
var map__34594__$1 = ((((!((map__34594 == null)))?(((((map__34594.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34594.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34594):map__34594);
var style_map = cljs.core.get.call(null,map__34594__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__34594__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__34594__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__34596){
var vec__34597 = p__34596;
var s = cljs.core.nth.call(null,vec__34597,(0),null);
var style = cljs.core.nth.call(null,vec__34597,(1),null);
var start = cljs.core.nth.call(null,vec__34597,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__34600){
var vec__34601 = p__34600;
var s = cljs.core.nth.call(null,vec__34601,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__34601,(1),null);
var element = cljs.core.nth.call(null,vec__34601,(2),null);
...
var G__34604 = cljs.core.next.call(null,ssv);
var G__34605 = (this_ssv == null);
var G__34606 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__34607 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && (!((this_ssv == null)))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__34604;
doing_nil_QMARK_ = G__34605;
last_elide = G__34606;
out = G__34607;
continue;
}
...
var vec__34608 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__34608,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__34608,(1),null);
var element_type = cljs.core.nth.call(null,vec__34608,(2),null);
...
var G__34611 = cljs.core.next.call(null,remaining_cvec);
var G__34612 = new_idx;
var G__34613 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__34611;
idx = G__34612;
out = G__34613;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__34624,cursor_vec){
var vec__34625 = p__34624;
var focus_start = cljs.core.nth.call(null,vec__34625,(0),null);
var focus_end = cljs.core.nth.call(null,vec__34625,(1),null);
var focus_vec = vec__34625;
...
var vec__34628 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__34628,(0),null);
var back = cljs.core.nth.call(null,vec__34628,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__34631){
var vec__34632 = p__34631;
var s = cljs.core.nth.call(null,vec__34632,(0),null);
var color = cljs.core.nth.call(null,vec__34632,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__34638,existing_count){
var vec__34639 = p__34638;
var s = cljs.core.nth.call(null,vec__34639,(0),null);
var cursor = cljs.core.nth.call(null,vec__34639,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__34639,s,cursor){
return (function (p1__34635_SHARP_){
return !(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__34635_SHARP_)));
});})(s__$1,len,cursor__$1,vec__34639,s,cursor))
...
var vec__34643 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__34643,(0),null);
var where = cljs.core.nth.call(null,vec__34643,(1),null);
var cvec_element = vec__34643;
if((cvec_element == null)){
var G__34646 = cljs.core.next.call(null,cvec_nl);
var G__34647 = (idx + (1));
var G__34648 = start;
var G__34649 = out;
cvec_nl = G__34646;
...
var G__34650 = cljs.core.next.call(null,cvec_nl);
var G__34651 = (idx + (1));
var G__34652 = idx;
var G__34653 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__34650;
idx = G__34651;
start = G__34652;
out = G__34653;
...
var G__34654 = cljs.core.next.call(null,cvec_nl);
var G__34655 = (idx + (1));
var G__34656 = (idx + (1));
var G__34657 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__34654;
idx = G__34655;
start = G__34656;
out = G__34657;
...
var G__34658 = cljs.core.next.call(null,cvec_nl);
var G__34659 = (idx + (1));
var G__34660 = idx;
var G__34661 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__34658;
idx = G__34659;
start = G__34660;
out = G__34661;
...
var G__34662 = cljs.core.next.call(null,cvec_nl);
var G__34663 = (idx + (1));
var G__34664 = start;
var G__34665 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__34662;
idx = G__34663;
start = G__34664;
out = G__34665;
...
return cljs.core.reduce.call(null,(function (p1__34667_SHARP_,p2__34666_SHARP_){
if(cljs.core.truth_(zprint.finish.within_QMARK_.call(null,idx,p2__34666_SHARP_))){
return cljs.core.reduced.call(null,p1__34667_SHARP_);
} else {
return (p1__34667_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__34668,p__34669){
var vec__34670 = p__34668;
var focus_begin = cljs.core.nth.call(null,vec__34670,(0),null);
var focus_end = cljs.core.nth.call(null,vec__34670,(1),null);
var vec__34673 = p__34669;
var before = cljs.core.nth.call(null,vec__34673,(0),null);
var after = cljs.core.nth.call(null,vec__34673,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__34677,cvec,focus_vec){
...
var map__34679 = cljs.core.get.call(null,map__34678__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__34679__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__34679__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__34679__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__34678,map__34678__$1,options,map__34679,map__34679__$1,focus,lines,paths){
return (function (p1__34676_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__34676_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__34678,map__34678__$1,options,map__34679,map__34679__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1554122654912
