...
return cljs.core.filter.call(null,(function (p1__35554_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__35554_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__35554_SHARP_) <= ending)));
}));
});
...
var G__35555 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__35557_SHARP_);
});})(and__3911__auto__))
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__35558_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__35558_SHARP_);
...
})),cljs.core.map.call(null,(function (p__35559){
var vec__35560 = p__35559;
var k = cljs.core.nth.call(null,vec__35560,(0),null);
var v = cljs.core.nth.call(null,vec__35560,(1),null);
...
var new_state = (function (){var G__35563 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,((function (G__35563,G__35563__$1,tags,reaction_id,state){
...
});})(G__35563,G__35563__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35563__$1)].join('')));
...
return (function (all_state,p__35564){
var vec__35565 = p__35564;
var sub_id = cljs.core.nth.call(null,vec__35565,(0),null);
var sub_state = cljs.core.nth.call(null,vec__35565,(1),null);
...
//# sourceMappingURL=metamorphic.js.map?rel=1554122659194
