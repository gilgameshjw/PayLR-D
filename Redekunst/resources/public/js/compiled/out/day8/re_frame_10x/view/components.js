...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__37260){
...
var title = cljs.core.get.call(null,map__37261__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.call(null,map__37261__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.call(null,map__37261__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.call(null,map__37261__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.call(null,map__37261__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v7v0.reagent.core.atom.call(null,title);
var save = ((function (val,map__37261,map__37261__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__37265,child){
...
var class$ = cljs.core.get.call(null,map__37266__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.call(null,map__37266__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v7v0.reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_){
return (function (p__37268,child__$1){
...
var class$__$1 = cljs.core.get.call(null,map__37269__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__37269,map__37269__$1,class$__$1,node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_.call(null,node,dom_node);
});})(map__37269,map__37269__$1,class$__$1,node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__37266,map__37266__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.call(null,(function (acc,p__37272){
var vec__37273 = p__37272;
var property = cljs.core.nth.call(null,vec__37273,(0),null);
var value = cljs.core.nth.call(null,vec__37273,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__37271_SHARP_){
...
var len__4499__auto___37278 = arguments.length;
var i__4500__auto___37279 = (0);
while(true){
if((i__4500__auto___37279 < len__4499__auto___37278)){
args__4502__auto__.push((arguments[i__4500__auto___37279]));

var G__37280 = (i__4500__auto___37279 + (1));
i__4500__auto___37279 = G__37280;
continue;
} else {
}
break;
...
var previous_config__37249__auto__ = devtools.prefs.get_prefs.call(null);
var prefs__37250__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_.call(null,prefs__37250__auto__);

return cljs.core.apply.call(null,api_fn,args);
}finally {if(cljs.core._EQ_.call(null,devtools.prefs.get_prefs.call(null),prefs__37250__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__37250__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_.call(null,previous_config__37249__auto__);
}});

day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq37276){
var G__37277 = cljs.core.first.call(null,seq37276);
var seq37276__$1 = cljs.core.next.call(null,seq37276);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37277,seq37276__$1);
});
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq37281){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37281));
});
...
var args__4502__auto__ = [];
var len__4499__auto___37286 = arguments.length;
var i__4500__auto___37287 = (0);
while(true){
if((i__4500__auto___37287 < len__4499__auto___37286)){
args__4502__auto__.push((arguments[i__4500__auto___37287]));

var G__37288 = (i__4500__auto___37287 + (1));
i__4500__auto___37287 = G__37288;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq37285){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37285));
});
...
var args__4502__auto__ = [];
var len__4499__auto___37290 = arguments.length;
var i__4500__auto___37291 = (0);
while(true){
if((i__4500__auto___37291 < len__4499__auto___37290)){
args__4502__auto__.push((arguments[i__4500__auto___37291]));

var G__37292 = (i__4500__auto___37291 + (1));
i__4500__auto___37291 = G__37292;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq37289){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37289));
});
...
var tag_name = first__37295;
var first__37295__$1 = cljs.core.first.call(null,seq__37294__$1);
var seq__37294__$2 = cljs.core.next.call(null,seq__37294__$1);
var attributes = first__37295__$1;
var children = seq__37294__$2;
...
day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__37299){
var vec__37300 = p__37299;
var class$ = cljs.core.nth.call(null,vec__37300,(0),null);
var expanded_QMARK_ = mranderson048.reagent.v0v7v0.reagent.core.atom.call(null,true);
return ((function (expanded_QMARK_,vec__37300,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__37300,class$))
});

day8.re_frame_10x.view.components.simple_render.cljs$lang$maxFixedArity = (2);

/** @this {Function} */
day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq37296){
var G__37297 = cljs.core.first.call(null,seq37296);
var seq37296__$1 = cljs.core.next.call(null,seq37296);
var G__37298 = cljs.core.first.call(null,seq37296__$1);
var seq37296__$2 = cljs.core.next.call(null,seq37296__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37297,G__37298,seq37296__$2);
});
...
//# sourceMappingURL=components.js.map?rel=1554122664274
