...
if((c === "\n")){
var G__32234 = escape_QMARK_;
var G__32235 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__32234;
lines = G__32235;
continue;
} else {
buf.append(c);

var G__32236 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__32237 = lines;
escape_QMARK_ = G__32236;
lines = G__32237;
continue;
...
//# sourceMappingURL=string.js.map?rel=1554122646192
