...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__32240_SHARP_){
var _STAR_delimiter_STAR_32241 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__32240_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_32241;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4502__auto__ = [];
var len__4499__auto___32250 = arguments.length;
var i__4500__auto___32251 = (0);
while(true){
if((i__4500__auto___32251 < len__4499__auto___32250)){
args__4502__auto__.push((arguments[i__4500__auto___32251]));

var G__32252 = (i__4500__auto___32251 + (1));
i__4500__auto___32251 = G__32252;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__32246){
var vec__32247 = p__32246;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__32247,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq32242){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32243,G__32244,G__32245,seq32242__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__32253 = rewrite_clj.reader.peek.call(null,reader);
switch (G__32253) {
case "(":
...
var G__32255 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__32255)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__32255)){
...
if(cljs.core._EQ_.call(null,"_",G__32255)){
...
//# sourceMappingURL=core.js.map?rel=1554122646278
